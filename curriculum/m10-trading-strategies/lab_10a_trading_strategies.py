# %% [markdown]
# # Lab 10a — Algorithmic Trading Strategies (M10)
#
...
#
# Costs of 5 bps per unit turnover are applied throughout. Lab 11a shows why that
...
print("Chart saved to", savefig(fig, "lab10a_equity_curves"))
...
print("Chart saved to", savefig(fig, "lab10a_pairs"))
