...
| Weeks | 20–22 |
| Hours | 36 guided |
| Labs | [10a](lab_10a_trading_strategies.py) — Trend, momentum, mean reversion, cross-sectional momentum, pairs |
| Library | `cfmat.strategies.signals`, `cfmat.backtesting.vectorized` |
...
3. Implement short-term mean-reversion (RSI, Bollinger) strategies and explain their regime dependence.
4. Implement cross-sectional momentum on a universe and control turnover.
5. Trade pairs with a formation period, an out-of-sample hedge ratio, entry/exit bands and a stop for breakdowns.
6. Describe event-driven, seasonality, carry and options-based strategies and when each is worth researching.
7. Combine strategies and reason about correlation, capacity and decay.
...
| C2 · Thu · 120 min | 0–60 parameter sensitivity of the trend system (a heat map, not a single number) · 60–100 peer review · 100–120 review |
...
| C2 · Thu · 120 min | 0–60 exercise: add a volatility filter to mean reversion · 60–100 peer review · 100–120 review |
