# %% [markdown]
# # Lab 12b — Strategy Creator, Backtesting and Parallel Optimisation (M12)
#
# **Goals**
...
print("Chart saved to", savefig(report.plot_backtest(bars, result), "lab12b_my_strategy"))
...
#    downtrend instruments from Lab 12a.
