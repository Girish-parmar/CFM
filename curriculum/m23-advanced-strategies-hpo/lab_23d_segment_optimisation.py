# %% [markdown]
# # Lab 23d — Strategy Optimisation by Segment: Day, Month, Regime, Pattern (M23)
#
# **Goals**
...
fig.colorbar(im)
print("Chart saved to", savefig(fig, "lab23d_weekday_regime_heatmap"))
...
print("many *backtests on the same data*, as in Lab 23a.")
...
# Same nested walk-forward tuning as Lab 23a, once with price features only and
...
# 2. Optimise the Lab 10a pairs strategy per *trend* regime instead of volatility regime.
