# %% [markdown]
# # Lab 23c — Meta-Labelling, Bet Sizing and Strategy Ensembles (M23)
#
# **Goals**
...
print("Chart saved to", savefig(fig, "lab23c_ensemble"))

# %% [markdown]
# ## Exercises
# 1. Tune the meta-model with `cfmat.ml.tuning.nested_walk_forward` and charge the
#    Deflated Sharpe for every configuration tried.
# 2. Replace the SMA primary with the Lab 23a boosted model and meta-label *that*.
