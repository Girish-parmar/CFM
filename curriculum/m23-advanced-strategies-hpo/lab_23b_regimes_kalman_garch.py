# %% [markdown]
# # Lab 23b — Regime Switching, Kalman-Filter Pairs and GARCH Volatility (M23)
#
# **Goals**
...
axes[1].legend()
print("Chart saved to", savefig(fig, "lab23b_regimes"))
...
ax.legend()
print("Chart saved to", savefig(fig, "lab23b_kalman_beta"))
