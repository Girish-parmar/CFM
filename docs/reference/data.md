...
| `macro_calendar` | `def macro_calendar(n_years: int = 10, seed: int \| None = None, start: str = '2015-01-01') -> MacroData` | Release calendar, data vintages, an equity index and the G-sec curve, with the answer key. |
| `MacroData` | `class MacroData(calendar: ForwardRef('pd.DataFrame'), releases: ForwardRef('pd.DataFrame'), market: ForwardRef('pd.DataFrame'), curves: ForwardRef('pd.DataFrame'), truth: ForwardRef('dict'))` | A synthetic Indian economy and its markets (``macro_calendar``). |
