...
|---|---|---|
| `sample_headlines.csv` | Module 22 labs, Module 18 lab, signal service tests | 48 headlines labelled positive / negative / neutral |
| `filings/*.md` | Module 22 lab (RAG) | Annual-report excerpts for three fictional companies |
