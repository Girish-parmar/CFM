...
Subpackages (course modules in brackets; see docs/REPO_MAP.md for the full map):
    ...
    analytics       metrics, indicators, patterns, momentum, volatility, tearsheets, CAPM/RS    [M04, M06, M10, M11]
    ...
    trading         OMS (stops, bracket/OCO, TIF, audit, reconciliation), RMS, paper broker,
                    trade journal with round trips, R-multiples and MAE/MFE                    [M17]
    ...
    viz             price, performance and analysis charts                                     [M10, M11, M17]
