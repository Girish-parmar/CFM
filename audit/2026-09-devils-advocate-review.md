...
| P1 | 16a market data handler | Algo-developer route; feeds M17–M18 | `data.handler`, tick-stream generator | Planted faults found with no false alarms; deterministic replay |
